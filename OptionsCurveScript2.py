...
if current_time > firstTime and current_time < lastTime:
    ...
    websiteList = ['https://www.barchart.com/futures/quotes/ZC*0/options', 'https://www.barchart.com/futures/quotes/ZSQ22/options/aug-21', 
                   'https://www.barchart.com/futures/quotes/KEU22/options', 'https://www.barchart.com/futures/quotes/ZWU22/options']
    expirationMonth = [['Jul 2022','Sep 2022','Dec 2022','Jul 2023','Dec 2023'],
                      ['Jul 2022','Aug 2022','Nov 2022'], 
                      ['Sep 2022'], ['Sep 2022']]
    ...
    for x in range(len(expirationMonth)):
        ...
        for expiration in expirationMonth[x]:
            ...
            driver = webdriver.Edge('//tedfil01/DataDropDev/PythonPOC/Christina Projects/msedgedriver.exe')
